...
router.post(
  "/:orderId/extra-payment/request",
  auth("user", "recruiter"),
  orderController.requestExtraPayment,
);

router.put(
  "/:orderId/extra-payment/:requestId/decide",
  auth("user", "recruiter"),
  orderController.decideExtraPayment,
);

router.post(
  "/:orderId/extra-payment/:requestId/pay",
  auth("user", "recruiter"),
  orderController.payExtraPayment,
);

router.post(
  "/:orderId/extra-payment/:requestId/paypal-order",
  auth("user", "recruiter"),
  orderController.createExtraPaymentPaypalOrder,
);
...
router.post(
  "/:orderId/request-support",
  auth("user", "recruiter"),
  orderController.requestSupport,
);
router.post(
  "/:orderId/admin/resolve-support",
  auth("admin"),
  orderController.adminResolveSupport,
);
